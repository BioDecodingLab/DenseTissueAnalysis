    ...
    if (endsWith(file, ".tif") || endsWith(file, ".TIF")) {
       ...
       // ---------------------------------------------------------------------
        ...
        lines = newArray(
        	...
        	118, 967, 148, 967, 167,	//14
        	63, 142, 161, 142, 179,		//15
        	120, 1063, 171, 1063, 192,	
        	215, 596, 198, 596, 229,
			37, 861, 190, 861, 213, 	//18
			43, 1304, 208, 1304, 226,
			109, 1441, 251, 1441, 268,	//20
			67, 251, 255, 251, 272,
			32, 978, 271, 978, 292,
        ...
        lines_xz = newArray(   
        	5, 1112, 116, 1112, 182,
        	15, 229, 43, 229, 97,
        	16, 1062, 158, 1062, 216,
        	10, 1067, 31, 1067, 111,
        	47, 154, 70, 154, 129,	//5
        	58, 1162, 8, 1162, 55,
        	62, 1178, 85, 1178, 136,
        	55, 1075, 180, 1075, 236,
        	...
        	201, 862, 8, 862, 58,
        	216, 1308, 26, 1308, 57,
        	261, 1444, 83, 1444, 128,	//20
        	264, 253, 46, 253, 85,	
        	280, 1222, 93, 1222, 162,
        	396, 1004, 131, 1004, 188,
