    ...
    if (endsWith(file, ".tif") || endsWith(file, ".TIF")) {
       ...
       // ---------------------------------------------------------------------
        ...
        lines = newArray(
        	...
        	44, 364, 132, 364, 153,
        	125, 744, 139, 744, 166,
        	58, 1180, 129, 1200, 129,	//10
        	55, 1101, 160, 1113, 181,
        	230, 437, 158, 437, 181,
        	144, 1559, 169, 1559, 193,
        	232, 1078, 41, 1078, 86,
        	133, 753, 780, 753, 824, 	//15
        	50, 1479, 737, 1479, 772,
        	137, 403, 571, 403, 604,
        	131, 1275, 556, 1275, 615,	
        	149, 625, 248, 652, 248,
        ...
        lines_xz = newArray(   
        	...
        	37, 100, 81, 100, 140,
        	67, 962, 28, 962, 87,
        	111, 1348, 9, 1348, 68,		 //5
        	110, 911, 131, 911, 196,
        	138, 827, 167, 827, 242,	
        	144, 438, 115, 438, 170,
        	179, 1533, 121, 1533, 186,
        	177, 970, 116, 970, 187,	//10
        	172, 1408, 25, 1408, 70,
        	183, 425, 167, 425, 218,
        	200, 1321, 127, 1321, 174,
        	202, 1001, 216, 1001, 259,	
        	206, 896, 107,	 896, 156,	//15	
        	199, 885, 17, 885, 88,
        	150, 844, 164, 844, 228,	
        	164, 1092, 61, 1092, 118,
        	164, 863, 104, 863, 150,
        	172, 354, 123, 354, 168,	//20
        	182, 426, 170, 426, 215,
        	244, 1265, 59, 1265, 103,
        	388, 942, 4, 942, 77,		
        	256, 515, 66, 515, 119,
