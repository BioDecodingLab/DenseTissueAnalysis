...
def main():
    ...
    parser.add_argument('--path', default=r'/media/hmorales/MyBookDuo/Data/DataIsoReconstructions/nuclei2membranes/')
    ...
    parser.add_argument('--imshow_interval',type=int,default=500)
