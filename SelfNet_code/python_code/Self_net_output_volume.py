...
def upsample_block(raw_img,x_res,z_res,deblur_netA,deblur_netB, min_v, max_v):
    ...
    thread2=myThread(2,'thread:2',deblur_netB,device1,min_v,max_v,out_yz_img,yz_img)
...
if __name__ == "__main__":
    ...
    test_path=r'/media/hmorales/MyBookDuo/Data/DataIsoReconstructions/nuclei2nuclei/'
    model_path=test_path+'checkpoint/saved_models/deblur_net_6_174000.pkl'
    ...
    raw_img=tifffile.imread(test_path+'/test_data/memRFPhisGFP_20230821_T010_A001.tif')

    scale=0.23160005

    fusion_stack=upsample_block(raw_img,scale,1,deblur_net_A,deblur_net_B,min_v,max_v)

    tifffile.imwrite(test_path+'/test_data/Self_Net_output.tif',fusion_stack)
